# Zadatak 25.
# program koji korisniku daje informacije o trenutnom tečaju spec. valute
...
while True:
    ...
    for c in countries:
        if c.oznaka == kod:
            c.display()
            break
    else:    # fun-fact: for petlje i while petlje imaju else statement -> ako su završile "prirodnim" putem
